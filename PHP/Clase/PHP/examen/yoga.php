...
<head>
    <meta charset="UTF-8">
    <title>Yoga - Gimnasio</title>
    <link rel="stylesheet" href="style.css">
</head>

<body>
    <h1>Reservar o Cancelar Clase de Yoga</h1>
    ...
    <script>
        ...
        function actualizarDias() {
            ...
            const dias = Object.keys(horarioClases['yoga']);
            dias.forEach(dia => {
                const option = document.createElement('option');
                option.value = dia;
                option.textContent = `${dia.charAt(0).toUpperCase() + dia.slice(1)} - ${horarioClases['yoga'][dia].hora} (Plazas disponibles: ${horarioClases['yoga'][dia].plazas_disponibles})`;
